...
ActiveRecord::Schema.define(version: 2021_12_06_055215) do
  ...
  create_table "sendings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_record_id"], name: "index_sendings_on_purchase_record_id"
  end
  ...
  add_foreign_key "sendings", "purchase_records"
end
